...
export const PRODUCTS: Product[] = [
  /* ------------------- TREEMATE — AU ------------------- */
  {
    ...
    pitch: "Site assessment, AS 4373 quotes, hazards, photos, invoicing. Built by an arborist.",
    status: "live",
    tone: "AU",
    brandHex: "#22c55e",
    brandHexDeep: "#15803d",
    ...
    faq: [
      { q: "Will it work in the bush with no signal?",
        a: "Yes. Quotes, photos, job reports queue offline and push when you're back in range. Photos compress on-device, so they don't tank your data plan." },
  ...
  /* ------------------- POOLMATE — UK ------------------- */
  {
    ...
    pitch: "Routes, chemical logs, dosing calculator, photo reports.",
    status: "live",
    tone: "UK",
    brandHex: "#0CA5EB",
    brandHexDeep: "#0369a1",
  ...
  /* ------------------- FIREMATE — UK ------------------- */
  {
    ...
    pitch: "BS 8214 fire-door surveys, dual sign-off, compliance register.",
    status: "beta",
    tone: "UK",
    brandHex: "#dc2626",
    brandHexDeep: "#b91c1c",
    ...
    feats: [
      { n: "01", title: "71-item BS 8214:2016 checklist",
        body: "Every door registered, surveyed on schedule, with photo evidence on every fail. Built in, not bolted on." },
  ...
  /* ------------------- PESTMATE — UK ------------------- */
  {
    ...
    pitch: "Recurring rounds, bait-point mapping, HSE-traceable products, branded reports.",
    status: "beta",
    tone: "UK",
    brandHex: "#16a34a",
    brandHexDeep: "#166534",
  ...
  /* ------------------- HYGIENEMATE — UK ------------------- */
  {
    ...
    pitch: "Recurring schedules, before and after photos, batch-tracked chemicals.",
    status: "beta",
    tone: "UK",
    brandHex: "#0891b2",
    brandHexDeep: "#0e7490",
  ...
  /* ------------------- LOCKSMITHMATE — UK ------------------- */
  {
    ...
    pitch: "Phone dispatch, live ETA, BS 3621 stock list, photo and invoice on site.",
    status: "beta",
    tone: "UK",
    brandHex: "#d97706",
    brandHexDeep: "#b45309",
    ...
    feats: [
      { n: "01", title: "Phone-first job dispatch",
        body: "Calls in, locked-out customer on the line. Quote, ETA, address in 30 seconds. Job goes straight to the assigned tech." },
      { n: "02", title: "Pre-arrival trust pack",
        body: "Customer gets your photo, MLA badge, DBS card and live ETA before you knock. Automatic." },
